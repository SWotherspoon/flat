...
##'   \code{object$term} and \code{object$by}. The \code{by} variable
##'   must be the last element.
##' @param knots a list containing any knots supplied for basis setup
##'   in same order and with same names as \code{data}. Cannot be
##'   \code{NULL}.
##' @return An object of class "fb.smooth", containing the elements of a
##'   smooth class documented under \code{\link{smooth.construct}}.
##' @export
...
##' A method for \code{\link{Predict.matrix}} for penalized cubic
...
##'   \code{\link{smooth.construct}} method having processed a smooth
##'   specification object generated by an \code{\link{s}} or
##'   \code{\link{te}} term in a \code{\link{gam}} formula.
##' @param data A data frame containing the values of the (named)
##'   covariates at which the smooth term is to be evaluated. Exact
##'   requirements are as for \code{\link{smooth.construct}}
