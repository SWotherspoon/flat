...
##' A method for [Predict.matrix()] for penalized cubic
...
##'   [smooth.construct()] method having processed a smooth
##'   specification object generated by an [s()] or
##'   [te()] term in a [gam()] formula.
##' @param data A data frame containing the values of the (named)
##'   covariates at which the smooth term is to be evaluated. Exact
##'   requirements are as for [smooth.construct()]
